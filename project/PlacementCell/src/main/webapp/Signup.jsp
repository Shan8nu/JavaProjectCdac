            ...
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                        <form id="login-form" class="form" action="Signup2.jsp" method="post">
                            <h3 class="text-center text-black">Sign Up</h3>
                            <div class="form-group">
                                <label for="username" class="text-black">Email Id:</label><br>
                            ...
                            <div class="form-group">
                                <label for="password" class="text-black">Confirm Password:</label><br>
                                <input type="text" name="password" id="password" class="form-control">
                            </div>
                            <div class="form-group">                                
