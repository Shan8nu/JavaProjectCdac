...
<nav class="navbar navbar-expand-lg navbar-light bg-light bg-transparent" id="gtco-main-nav">
    <div class="container"><a href="MainHomepage.jsp" class="navbar-brand">Solution</a>
        ...
        <div id="my-nav" class="collapse navbar-collapse">
            ...
            <form class="form-inline my-2 my-lg-0">
                <a href="StudentLogin.jsp" class="btn btn-outline-dark my-2 my-sm-0 mr-3 text-uppercase">login</a> 
        ...
        <div class="row">
            <div class="col-md-6">
                <h1> We promise to bring
                    the best <span>Opportunities</span> for
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-5">
                <h2> Who We Are? </h2>
                <p>
                Our vision is to bring credible and genuine assessment to various aspects of education, training and employment.
                Solution strives to help institutions and companies from choosing the 'right' individual rather than the 'best' individual.
                Founded by 6 Musketeers, the Solution team is 160 people strong, boasting of alumni of premier institutions such IIMs, IITs and NITs with dozens of years of experience at various large corporate and MNCs.
                 With offices in Delhi, Bangalore and Mumbai and full-time presence across all major cities, Solution team is committed to servicing its clients and partners at the highest possible standards.               
                </p>
        </div>
    </div>
</div>
                    ...
                    <div class="col">
                        ...
                        <div class="card text-center">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Marketing is the business process of creating relationships with and satisfying customers</p>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card text-center">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Search engine optimization is the process of increasing the quality and quantity of website traffic by increasing visibility of a website or a web page to users of a web search engine</p>
                            </div>
                        </div>
                        <div class="card text-center">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Graphic design is the process of visual communication and problem-solving through the use of typography, photography, and illustration</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="owl-carousel owl-carousel1 owl-theme">
            <div>
                <div class="card text-center"><img class="card-img-top" src="images/customer1.jpg" alt="">
                    <div class="card-body">
                        <h5>Lisa Gally <br/>
                            <span> Software Engineer </span></h5>
                        <p class="card-text"> Tumchya Aaichi Gand  </p>
                    </div>
                </div>
            </div>
            <div>
                <div class="card text-center"><img class="card-img-top" src="images/customer2.jpg" alt="">
                    <div class="card-body">
                        ...
                        <p class="card-text"> Lavdyanno Kaam Kara....Halvu Naka  </p>
                    </div>
                </div>
            </div>
            <div>
                <div class="card text-center"><img class="card-img-top" src="images/customer3.jpg" alt="">
                    <div class="card-body">
                        <h5>Aana Brown<br/>
                            <span> CEO </span></h5>
                        <p class="card-text"> Bapach Aikt jaa MC  </p>
                    </div>
                </div>
            </div>
            <div>
                <div class="card text-center"><img class="card-img-top" src="images/customer3.jpg" alt="">
                    <div class="card-body">
                        <h5>Aana Brown<br/>
                            <span> Founder </span></h5>
                        <p class="card-text"> Saapala chavayla aani baapala zavyla shikvych naay...  </p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="media col-md-6 col-lg-4">
                ...
                <div class="media-body">
                    ...
                    With our flexible pricing model, we can offer you the ideal plan for your business. Pricing varies depending on your monthly ad spend, number of accounts managed in Acquisio, as well as the term of your contract.
                </div>
            </div>
            ...
            <div>
                <div class="card text-center"><img class="card-img-top" src="images/news1.jpg" alt="">
                    <div class="card-body text-left pr-0 pl-0">
                        <h5>AI can meaningfully improve people's lives and that the biggest impact will come when everyone can access it.</h5>
                       
                        <p class="card-text">
                        Announcing the release of three new multilingual Universal Sentence Encoder (USE) modules, useful for a variety of semantic similarity applications and now providing support for question-answer retrieval tasks    </p>
                        <a href="https://www.linkedin.com/company/googleai/">READ MORE <i class="fa fa-angle-right" aria-hidden="true"></i></a></div>
                </div>
            </div>
            <div>
                <div class="card text-center"><img class="card-img-top" src="images/news2.jpg" alt="">
                    <div class="card-body text-left pr-0 pl-0">
                        <h5>Machine learning is linked to artificial intelligence, the development of computers with skills</h5>
                        <p class="card-text">
                        Pype is a rapidly growing technology/SaaS company set out to disrupt the trillion-dollar construction industry. We are providing solutions for commercial general contractors in North America.
                        </p>
                        <a href="https://www.linkedin.com/jobs/view/1331850710/">READ MORE <i class="fa fa-angle-right" aria-hidden="true"></i></a></div>
                </div>
            </div>
            <div>
                <div class="card text-center"><img class="card-img-top" src="images/news3.jpg" alt="">
                    <div class="card-body text-left pr-0 pl-0">
                        <h5>Deep learning training computers to teach themselves by sifting through massive amounts of data represents data as multiple levels of abstraction</h5>
                        <p class="card-text">
                        Move IT is an IT consultancy and professional services firm based in Asia, specializing in IT resourcing solutions, as well as office and data centre migrations
                         </p>
                        <a href="https://www.linkedin.com/jobs/view/1331291549/">READ MORE <i class="fa fa-angle-right" aria-hidden="true"></i></a></div>
                </div>
            </div>
        </div>
    </div>
